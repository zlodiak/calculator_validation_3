        ...
        <div class="row <%= visibility %>">
          <div class="col-xs-6 form-group">
            ...
            <div class="input-group">
              <label>
                <input name="lathingRatio" type="radio" value="1" checked=""> К=<b>1</b> 
              ...
              <br>
               ...
               <label>
                <input name="lathingRatio" type="radio" value="1.5"> К=<b>1,5</b> 
               ...
               <label>
                <input name="lathingRatio" type="radio" value="2"> К=<b>2</b> 
